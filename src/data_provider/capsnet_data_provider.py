...
class DataProvider:
    def __init__(self,data_file,
                 ...
                 task_name,
                 data_path,
                 sequence_encode_func,
                 sequence_encode_func2,
                 batch_size,
                 max_len_hla=273,
                 max_len_pep=37,
                 model_count=5,
        ...
        self.hla_sequence = {}
        self.read_hla_sequences(train_name, task_name, data_path)
    ...
    def read_hla_sequences(self, train_name, task_name, data_path):
        _, _, file_path = get_data(train_name,
                                   task_name,
                                   data_path)
